        ...
        <div class="col-lg-3 col-md-3">
          ...
          <div class="form-group">
            <!--    <a href="map.html">
              ...
              <div class="dropup-img"><img src="img/north-west.png" alt=""></div>
              
            <button class="btn select-region uppercase">
              <span class="focused">Сохранить выбор</span>
             <span class="non-focused">Выбрать регион</span>
            </button>
            ...
            <ul class="dropdown map-dropdown">
              ...
              <li class="dropdown-header">
                ...
                <label for="southern" class="title">
                  Южный ФО
                </label>
                <ul class="dropdown-child">
                  <li>
              ...
              <li class="dropdown-header">
                ...
                <label for="north-west" class="title">
                  Северо-Западный ФО
                </label>
                <ul class="dropdown-child">
                  <li>
              ...
              <li class="dropdown-header">
                ...
                <label for="privolzhskiy" class="title">
                  Приволжский ФО
                </label>
                <ul class="dropdown-child">
                  <li>
              ...
              <li class="dropdown-header">
                ...
                <label for="uralskiy" class="title">
                  Уральский ФО
                </label>
                <ul class="dropdown-child">
                  <li>
              ...
              <li class="dropdown-header">
                ...
                <label for="siberian" class="title">
                  Сибирский ФО
                </label>
                <ul class="dropdown-child">
                  <li>
              ...
              <li class="dropdown-header">
                ...
                <label for="north-kavkasian" class="title">
              ...
              <li class="dropdown-header">
                ...
                <label for="far-eastern" class="title">
                 Дальневосточный ФО
                </label>
                <ul class="dropdown-child">
                  <li>
